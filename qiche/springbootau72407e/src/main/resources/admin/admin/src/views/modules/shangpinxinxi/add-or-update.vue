<template>
	<div class="addEdit-block" :style='{"padding":"20px 30px 30px","margin":"0 auto","color":"#555","borderRadius":"0 0 10px 10px","background":"rgba(255,255,255,.69)","width":"86%","fontSize":"16px"}'>
		...
		>
			<template >
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="汽车名称" prop="shangpinmingcheng">
					<el-input  v-model="ruleForm.shangpinmingcheng" placeholder="汽车名称" clearable  :readonly="ro.shangpinmingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else class="input" label="汽车名称" prop="shangpinmingcheng">
					<el-input v-model="ruleForm.shangpinmingcheng" placeholder="汽车名称" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="select" v-if="type!='info'"  label="汽车种类" prop="shangpinzhonglei">
					<el-select :disabled="ro.shangpinzhonglei" v-model="ruleForm.shangpinzhonglei" placeholder="请选择汽车种类" >
						<el-option
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else class="input" label="汽车种类" prop="shangpinzhonglei">
					<el-input v-model="ruleForm.shangpinzhonglei"
						placeholder="汽车种类" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="upload" v-if="type!='info' && !ro.shangpintupian" label="汽车图片" prop="shangpintupian">
					<file-upload
						tip="点击上传汽车图片"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="upload" v-else-if="ruleForm.shangpintupian" label="汽车图片" prop="shangpintupian">
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-if="type!='info'"  label="汽车详情" prop="shangpinxiangqing">
					<editor 
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else-if="ruleForm.shangpinxiangqing" label="汽车详情" prop="shangpinxiangqing">
                    <span :style='{"fontSize":"14px","lineHeight":"24px","color":"inherit","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.shangpinxiangqing"></span>
                </el-form-item>
...
export default {
	data() {
		...
		return {
			...
			rules: {
				...
				shangpinzhonglei: [
					{ required: true, message: '汽车种类不能为空', trigger: 'blur' },
				],
				shangpintupian: [
				],
				shangpinxiangqing: [
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.shangpinxiangqing = this.ruleForm.shangpinxiangqing.replace(reg,'../../../springbootau72407e/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
