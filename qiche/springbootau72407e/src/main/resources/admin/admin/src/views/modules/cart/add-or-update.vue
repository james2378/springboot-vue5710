<template>
	<div class="addEdit-block" :style='{"padding":"20px 30px 30px","margin":"0 auto","color":"#555","borderRadius":"0 0 10px 10px","background":"rgba(255,255,255,.69)","width":"86%","fontSize":"16px"}'>
		...
		>
			<template >
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="汽车表名" prop="tablename">
					<el-input  v-model="ruleForm.tablename" placeholder="汽车表名" clearable  :readonly="ro.tablename"></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else class="input" label="汽车表名" prop="tablename">
					<el-input v-model="ruleForm.tablename" placeholder="汽车表名" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="汽车id" prop="goodid">
					<el-input  v-model="ruleForm.goodid" placeholder="汽车id" clearable  :readonly="ro.goodid"></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else class="input" label="汽车id" prop="goodid">
					<el-input v-model="ruleForm.goodid" placeholder="汽车id" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="汽车名称" prop="goodname">
					<el-input  v-model="ruleForm.goodname" placeholder="汽车名称" clearable  :readonly="ro.goodname"></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else class="input" label="汽车名称" prop="goodname">
				...
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="商户名称" prop="shangjiahao">
					<el-input  v-model="ruleForm.shangjiahao" placeholder="商户名称" clearable  :readonly="ro.shangjiahao"></el-input>
				</el-form-item>
				<el-form-item :style='{"color":"inherit","margin":"0 0 20px 0","fontSize":"inherit"}' v-else class="input" label="商户名称" prop="shangjiahao">
					<el-input v-model="ruleForm.shangjiahao" placeholder="商户名称" readonly></el-input>
				</el-form-item>
			</template>
