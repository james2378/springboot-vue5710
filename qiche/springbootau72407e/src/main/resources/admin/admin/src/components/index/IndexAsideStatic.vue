<template>
	<div class="menu-preview">
		...
		<el-menu :default-active="activeMenu" :unique-opened="true" :style='{"border":0,"padding":"0","listStyle":"none","margin":"0","flexWrap":"wrap","background":"none","display":"flex","width":"100%","position":"inherit","transition":"all 0s ease"}' mode="horizontal" class="el-menu-horizontal-2">
		    <el-menu-item class="home" :style='{"border":"0","padding":"0","listStyle":"none","margin":"0","color":"#fff","background":"none","display":"none","float":"left"}' @click.native="menuHandler('')" index="/">
				<div class="el-tooltip">
					...
					<span :style='{"color":"inherit","verticalAlign":"middle","fontSize":"14px"}' slot="title">控制台</span>
				</div>
			</el-menu-item>
		...
		this.$http({
			...
			if (data && data.code === 0) {
				...
				if(sessionTable == 'shangjia') {
					this.avatar = data.data.shangpuzhaopian
				}
