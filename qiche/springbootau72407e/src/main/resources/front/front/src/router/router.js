...
import shangpinzhongleiList from '../pages/shangpinzhonglei/list'
import shangpinzhongleiDetail from '../pages/shangpinzhonglei/detail'
import shangpinzhongleiAdd from '../pages/shangpinzhonglei/add'
    ...
    },
		{
			...
			children:[
				...
				},
				{
					...
					component: shangpinzhongleiList
				},
				{
					path: 'shangpinzhongleiDetail',
					component: shangpinzhongleiDetail
				},
				{
					path: 'shangpinzhongleiAdd',
					component: shangpinzhongleiAdd
				},
				{
					path: 'shangpinxinxi',
