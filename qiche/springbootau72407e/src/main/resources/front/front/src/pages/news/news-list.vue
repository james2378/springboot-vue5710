...
<div>
	...
	<div class="news-preview-pv" :style='{"width":"100%","margin":"0px auto","position":"relative","background":"#fff"}'>
		...
		<!-- 热门信息 -->
		<div class="hot" :style='{"width":"48%","padding":"0 0 0 7%","margin":"40px 0 0","float":"left","background":"#fff","height":"auto"}'>
		  ...
		  <div :style='{"margin":"20px 0","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
		    <div v-for="item in hotList" :key="item.id" :style='{"cursor":"pointer","width":"48%","padding":"0","margin":"0 0 20px","background":"#fff","height":"auto"}' @click="toNewsDetail(item)">
		...
		<!-- 最新动态 -->
		<div class="news" :style='{"width":"48%","padding":"0 7% 0 0","margin":"40px 0 0","float":"right","background":"#fff","height":"auto"}'>
		  <div :style='{"padding":"0 20px 6px","color":"#F5BB00","textAlign":"center","background":"url(http://codegen.caihongy.cn/20230915/b96d1e15768f4ac495e60a79e04cb731.png) no-repeat center bottom","width":"100%","lineHeight":"50px","fontSize":"32px"}'>最新动态</div>
		  <div :style='{"padding":"0px","margin":"20px 0","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
		    <div v-for="item in recommendList" :key="item.id" :style='{"cursor":"pointer","width":"49%","margin":"0 0 20px","background":"#fff","height":"auto"}' @click="toNewsDetail(item)">
		      <img :style='{"width":"100%","objectFit":"cover","display":"block","height":"150px"}' :src="baseUrl + item.picture" alt="">
		      <div :style='{"padding":"0 10px","borderColor":"#eee","overflow":"hidden","whiteSpace":"nowrap","color":"#666","textAlign":"center","borderWidth":"0 0 1px","width":"100%","lineHeight":"32px","fontSize":"14px","textOverflow":"ellipsis","borderStyle":"solid"}'>{{ item.title }}</div>
		      <div :style='{"padding":"0 10px","lineHeight":"32px","fontSize":"14px","color":"#999","textAlign":"right"}'>{{item.addtime}}</div>
		    </div>
